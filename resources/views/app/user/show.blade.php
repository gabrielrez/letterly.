    ...
    <main class="mt-12 flex gap-24">
        ...
        <div class="w-full">
            ...
            <div class="flex gap-6 mt-12">
                ...
                @if(1 > 2)
                <div class="bg-primary px-7 py-2 rounded-[4px]">
                    <p class="font-semibold text-white">Following <i class="fa-solid fa-check ml-1"></i></p>
                </div>
                @else
                <a href="/" class="text-primary hover:text-white border-2 border-primary hover:border-transparent hover:bg-primary px-7 py-2 rounded-[4px] transition duration-200 ease-in-out">
                    <p class="font-semibold">Follow <i class="fa-solid fa-user-plus ml-1"></i></p>
                </a>
                @endif
